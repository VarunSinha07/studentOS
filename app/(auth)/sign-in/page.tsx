...
export default function SignIn() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[#07070a] text-slate-200 overflow-hidden font-sans selection:bg-emerald-500/30 selection:text-emerald-200">
      ...
      <div
        ref={windowRef}
        className="relative z-10 w-full max-w-[440px] px-6 sm:px-0 opacity-0"
      >
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between ml-1">
                  ...
                  <Link
                    href="/reset-password"
                    className="text-xs font-mono text-emerald-500/80 hover:text-emerald-400 transition-colors"
                  >
                    recover_key?
                  </Link>
                </div>
                ...
                >
                  {loading ? (
                    <>
                      ...
                      <span className="tracking-wide">Validating...</span>
                    </>
                  ) : (
                    <>
